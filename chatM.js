let conversas = [];
var db = firebase.firestore().collection('chat').where("Id_m", "==", user.uid);
   db.get()
    .then(function(querySnapshot) {
        ...
        conversas.forEach(conversa => {
          ...
          html += `</li>`;
                    ...
                    var db2 = firebase.firestore().collection('users').doc(conversa.Id_p);
